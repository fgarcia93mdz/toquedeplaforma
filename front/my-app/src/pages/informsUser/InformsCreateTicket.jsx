        ...
        <Grid container my={4}>
          ...
          >
            ...
            <FormControl >
              ...
              >
                <FormControlLabel value={'1'} control={<Radio />}  sx={{color: 'white'}} label="En Platarfoma" />
                <FormControlLabel value={'2'} control={<Radio />} sx={{color: 'white',}} label="Ingresando" />
                <FormControlLabel value={'3'} control={<Radio />}  sx={{color: 'white'}} label="Servicio sin Platarfoma" />
                <FormControlLabel value={'4'} control={<Radio />}  sx={{color: 'white'}} label="Fuera de Platarfoma" />
              </RadioGroup>
            </FormControl>
          </Grid>
          <Grid
